...
public class SMSUtils {
	...
	private static final String ACCESS_KEY="LTAI4GAzmi26SYZEZQbTDuvX"; //你的AccessKey ID
	private static final String SECRET_KEY="Ye3bZ3K3N7vI1jduS2L6VECi9jbrdj"; //你的AccessKey Secret
